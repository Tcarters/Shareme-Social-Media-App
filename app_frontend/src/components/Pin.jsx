...
import { v4 as uuidv4} from 'uuid' // help to implement uniq user identifier on app
...
const Pin = ({ pin: { postedBy, image, _id, destination, save }}) => {
    ...
    // console.log(' Value of save: ',  save )
  ...
  return (
    <div className='m-2'>
        <div
            ...
            className='relative cursor-zoom-in w-autoi hover:shaodw-lg rounded-lg overflow-hidden tranisition-all duration-500 ease-in-out'
            >
                            ...
                            <div className='flex gap-2' >
                                <a
                                 ...
                                 className="bg-white w-9 h-9 rounded-full flex 
                                    items-center justify-center text-dark text-xl opacity-75  over:opacity-100 hover:shadow-md outline-none"
                                >
                            ...
                            <div className='flex justify-between items-center gap-2 w-full'> 
                                { destination && (
                                    ...
                                    >
                                        ...
                                        {/* //.length > 20 ?  destination.slice(8, 20) : destination.slice(8) } */}
                                    </a>
                                )}
