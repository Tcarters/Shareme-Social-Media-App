...
const CreatePin = ( { user }) => {
  ...
  const uploadImage  = (e) => {
    ...
    if (type === 'iamge/png' || type === 'image/svg' || type === 'image/jpeg' || type === 'image/gif' || type === 'image/tiff') {
      ...
      <div className=' flex lg:flex-row flex-col justify-center items-center bg-white lg:p-5 p-3 lg:w-4/5  w-full' >
              ...
              {!imageAsset ? (
                <label>
                  ...
                  <p className='mt-32 text-gray-400'>
                      Notice: Use high-quality JPG, JPEG, SVG, PNG, GIF or TIFF less than 20 MB
                  </p>
                  </div>
                  <input 
                     type="file"
        ...
        <div className='flex flex-1 flex-col gap-6 lg:pl-5 mt-5 w-full'>
          ...
          <div className="flex flex-col">
            ...
            <div className='flex flex justify-end items-end mt-5'>
              <button
                type='button'
                onClick={savePin}
